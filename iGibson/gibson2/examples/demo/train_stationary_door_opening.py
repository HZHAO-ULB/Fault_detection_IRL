...
def main():
    ...
    for update in range(start_epoch, args.num_updates):
        ...
        if update > 0 and update % args.eval_interval == 0 and args.env_mode == "gui":
            current_reward = evaluate(eval_envs,
                     ...
                     eval_only=False)
        elif update > 0 and update % int(150/args.num_steps) == 0 and args.env_mode != "gui":
