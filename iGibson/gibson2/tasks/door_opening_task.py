...
class DoorOpeningTask(PointNavFixedTask):
    """
    ...
    def __init__(self, env):
        super(DoorOpeningTask, self).__init__(env)
    ...
    def sample_initial_pose_and_target_pos(self, env):
        ...
        initial_orn = np.array([0, 0, 3*np.pi/4+(np.pi/8)])
    ...
    def reset_scene(self, env):
        ...
        super(DoorOpeningTask, self).reset_scene(env)
    ...
    def reset_agent(self, env):
        ...
        super(DoorOpeningTask, self).reset_agent(env)
