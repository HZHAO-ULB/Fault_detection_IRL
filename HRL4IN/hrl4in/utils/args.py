...
def add_env_args(parser):
    ...
    group.add_argument(
        "--config-file",
        type=str,
        default=os.path.join(gibson2.example_config_path, 'door_opening_stadium.yaml'),
...
def add_common_args(parser):
    ...
    group.add_argument(
        "--experiment-folder",
        type=str,
        default="/media/zhq/A4AB-0E37/igibson_FDD_exp",
...
def add_ppo_args(parser):
    ...
    group.add_argument(
        ...
        type=int,
        default=15,
        help="number of batches for ppo (default: 18)",
    )
    group.add_argument(
        "--value-loss-coef",
        type=float,
